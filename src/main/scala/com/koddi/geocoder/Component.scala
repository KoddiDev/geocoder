...
case class AdministrativeAreaComponent(value: String)
    extends AbstractComponent(Component.ADMINISTRATIVE_AREA, value)

/** Serializes to "postal_code=value" */
case class PostalCodeComponent(value: String)
    extends AbstractComponent(Component.POSTAL_CODE, value)
...
case class Parameters(
  ...
  def appendToUrlBuilder(builder: StringBuilder): Unit = {
    language match {
      case Some(value) =>
        appendQueryParameter(builder, Geocoder.API_PARAM_LANGUAGE, value)
      case None => // default
    }

    region match {
      case Some(value) =>
        appendQueryParameter(builder, Geocoder.API_PARAM_REGION, value)
      case None => // default
    }
    ...
    resultType match {
      case Some(value) =>
        appendQueryParameter(
            builder,
            Geocoder.API_PARAM_RESULT_TYPE,
            value.mkString("|")
        )
      case None => // default
    }
    ...
    locationType match {
      case Some(value) =>
        appendQueryParameter(
            builder,
            Geocoder.API_PARAM_LOCATION_TYPE,
            value.mkString("|")
        )
      case None => // default
    }
  ...
  private def appendQueryParameter(builder: StringBuilder, key: String, value: String): Unit = {
    builder.append("&")
